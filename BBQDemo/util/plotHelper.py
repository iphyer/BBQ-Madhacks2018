...
def plotloc(loc_list, dirPath):
    ...
    plt.plot()
    # plt.show()
    fig.savefig(os.path.join(dirPath, "loc.png"), dpi=190, bbox_inches='tight', pad_inches=0)
...
def plotcls(cls_list, dirPath):
    ...
    plt.plot()
    # plt.show()
    fig.savefig(os.path.join(dirPath, "cls.png"), dpi=190, bbox_inches='tight', pad_inches=0)